...
set_target_properties(Poco::NetSSL PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoNetSSL.so.95"
  IMPORTED_SONAME_RELWITHDEBINFO "libPocoNetSSL.so.95"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::NetSSL )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::NetSSL "${_IMPORT_PREFIX}/lib/libPocoNetSSL.so.95" )
