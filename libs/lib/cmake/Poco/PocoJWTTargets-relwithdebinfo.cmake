...
set_target_properties(Poco::JWT PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoJWT.so.95"
  IMPORTED_SONAME_RELWITHDEBINFO "libPocoJWT.so.95"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::JWT )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::JWT "${_IMPORT_PREFIX}/lib/libPocoJWT.so.95" )
